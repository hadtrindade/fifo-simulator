...
class Ui_FifoSimulator(object):
    def setupUi(self, FifoSimulator):
        ...
        self.result_process.setStyleSheet(u"")
        ...
        self.label_stats.setGeometry(QRect(10, 10, 451, 131))
